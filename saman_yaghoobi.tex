...
\usepackage[
pdftitle={Saman Yaghoobi's CV},
pdfauthor={Saman Yaghoobi},
...
\patchcmd{\ps@customFooterStyle}{\thepage}{
	\color{gray}\textit{\small Saman Yaghoobi - Page \thepage{} of \pageref*{LastPage}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Skills}
\vspace{0.2 cm} % Before each skill
\begin{onecolentry}
...
\vspace{0.2 cm}
\begin{onecolentry}
	\textbf{Certifications:} Network+, Cisco CCNA
\end{onecolentry}

\vspace{0.2 cm}
\begin{onecolentry}
	\textbf{VoIP and System Administration:} Basic Knowledge of VoIP technologies and system administration
\end{onecolentry}

\vspace{0.2 cm}
\begin{onecolentry}
	\textbf{SD-WAN:} Familiar with SD-WAN technologies
\end{onecolentry}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Projects}
